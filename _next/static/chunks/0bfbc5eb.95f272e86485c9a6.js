...
/* harmony export */   "LoggerWithoutDebug": function() { return /* binding */ LoggerWithoutDebug; },
/* harmony export */   "Model": function() { return /* binding */ Model; },
/* harmony export */   "ModelManager": function() { return /* binding */ ModelManager; },
/* harmony export */   "ModelValidationStatus": function() { return /* binding */ ModelValidationStatus; },
/* harmony export */   "POLYFILL_ETAG": function() { return /* binding */ POLYFILL_ETAG; },
/* harmony export */   "Wllama": function() { return /* binding */ Wllama; },
/* harmony export */   "WllamaAbortError": function() { return /* binding */ WllamaAbortError; },
/* harmony export */   "WllamaError": function() { return /* binding */ WllamaError; },
/* harmony export */   "isValidGgufFile": function() { return /* binding */ isValidGgufFile; }
/* harmony export */ });
/* harmony import */ var _swc_helpers_src_assert_this_initialized_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(918);
/* harmony import */ var _swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4656);
/* harmony import */ var _swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9648);
/* harmony import */ var _swc_helpers_src_inherits_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3459);
/* harmony import */ var _swc_helpers_src_instanceof_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8149);
/* harmony import */ var _swc_helpers_src_sliced_to_array_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1296);
/* harmony import */ var _swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8417);
/* harmony import */ var _swc_helpers_src_type_of_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4167);
/* harmony import */ var _swc_helpers_src_wrap_native_super_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6071);
/* harmony import */ var _swc_helpers_src_create_super_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4802);
/* harmony import */ var _swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2336);
...
var __knownSymbol = function(name, symbol) {
...
var __publicField = function(obj, key, value) {
    return __defNormalProp(obj, (typeof key === "undefined" ? "undefined" : (0,_swc_helpers_src_type_of_mjs__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(key)) !== "symbol" ? key + "" : key, value);
};
...
var __asyncGenerator = function(__this, __arguments, generator) {
    var resume = function(k, v, yes, no) {
        try {
            var x = generator[k](v), isAwait = (0,_swc_helpers_src_instanceof_mjs__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(v = x.value, __await), done = x.done;
            Promise.resolve(isAwait ? v[0] : v).then(function(y) {
                return isAwait ? resume(k === "return" ? k : "next", v[1] ? {
                    done: y.done,
                    value: y.value
                } : y, yes, no) : yes({
                    value: y,
...
var __forAwait = function(obj, it, method) {
    return (it = obj[__knownSymbol("asyncIterator")]) ? it.call(obj) : (obj = obj[__knownSymbol("iterator")](), it = {}, method = function(key, fn) {
...
function glueDeserialize(buf) {
    ...
    var readString = function(customLen) {
        var length = customLen != null ? customLen : readUint32();
        var value = new TextDecoder().decode(buf.slice(offset, offset + length));
        offset += length;
        return value;
    };
    ...
    var readArray = function(readItem) {
        var length = readUint32();
    ...
    var magicValid = buf[0] === GLUE_MAGIC[0] && buf[1] === GLUE_MAGIC[1] && buf[2] === GLUE_MAGIC[2] && buf[3] === GLUE_MAGIC[3];
    offset += 4;
    if (!magicValid) {
    ...
    var name = readString(8);
    var msgProto = GLUE_MESSAGE_PROTOTYPES[name];
    if (!msgProto) {
        throw new Error("Unknown message name: ".concat(name));
    }
    var output = {
        _name: name
    };
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = msgProto.fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var field = _step.value;
            var readType = readUint32();
            if (readType === GLUE_DTYPE_NULL) {
                if (!field.isNullable) {
                    throw new Error("".concat(name, ": Expect field ").concat(field.name, " to be non-nullable"));
                }
                output[field.name] = null;
                continue;
            }
            if (readType !== TYPE_MAP[field.type]) {
                throw new Error("".concat(name, ": Expect field ").concat(field.name, " to have type ").concat(field.type));
            }
...
function glueSerialize(msg) {
    var msgProto = GLUE_MESSAGE_PROTOTYPES[msg._name];
    if (!msgProto) {
        throw new Error("Unknown message name: ".concat(msg._name));
    }
    var bufs = [];
    ...
    var writeRaw = function(value) {
        writeUint32(value.byteLength);
        bufs.push(value);
    };
    var writeArray = function(value, writeItem) {
    ...
    {
        var utf8 = new TextEncoder().encode(msg._name);
        bufs.push(utf8);
    }
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = msgProto.fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var field = _step.value;
            var val = msg[field.name];
            if (!field.isNullable && (val === null || val === void 0)) {
                throw new Error("".concat(msg._name, ": Expect field ").concat(field.name, " to be non-nullable"));
            }
    ...
    var totalLength = bufs.reduce(function(acc, buf) {
...
// src/utils.ts
var joinBuffers = function(buffers) {
    var totalSize = buffers.reduce(function(acc, buf) {
...
var bufToText = function(buffer) {
    return textDecoder.decode(buffer);
};
var URL_PARTS_REGEX = /-(\d{5})-of-(\d{5})\.gguf(?:\?.*)?$/;
var parseShardNumber = function(fnameOrUrl) {
    var matches = fnameOrUrl.match(URL_PARTS_REGEX);
    if (!matches) {
        return {
            baseURL: fnameOrUrl,
            current: 1,
...
var sortFileByShard = function(blobs) {
    var isFiles = blobs.every(function(b) {
        return !!b.name;
    });
    if (isFiles && blobs.length > 1) {
        var files = blobs;
        files.sort(function(a, b) {
            var infoA = parseShardNumber(a.name);
            var infoB = parseShardNumber(b.name);
            return infoA.current - infoB.current;
        });
    }
};
var absoluteUrl = function(relativePath) {
...
var isString = function(value) {
    return !!(value == null ? void 0 : value.startsWith);
};
var isSupportMultiThread = function() {
    return function(e) {
        return __async(void 0, null, function() {
            return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                try {
                    return [
                        2,
                        ("undefined" != typeof MessageChannel && new MessageChannel().port1.postMessage(new SharedArrayBuffer(1)), WebAssembly.validate(e))
                    ];
                } catch (e2) {
                    return [
                        2,
...
var isSupportExceptions = function() {
    return __async(void 0, null, function() {
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            return [
                2,
...
var checkEnvironmentCompatible = function() {
    return __async(void 0, null, function() {
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            switch(_state.label){
                case 0:
...
var isValidGgufFile = function(path) {
    return GGUF_FILE_REGEX.test(path);
};
var isSafariMobile = function() {
    return !!navigator.userAgent.match(/Version\/([0-9\._]+).*Mobile.*Safari.*/);
};
var createWorker = function(workerCode) {
    var workerURL = URL.createObjectURL(isString(workerCode) ? new Blob([
        workerCode
    ], {
...
var cbToAsyncIter = function(fn) {
    return function() {
        ...
        var values = [];
        var resolve;
        values.push(new Promise(function(r) {
            resolve = r;
        }));
        fn.apply(void 0, (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(args).concat([
            function(val, done) {
                resolve([
                    val,
                    done
                ...
                return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 1:
                            ...
                            return [
                                4,
                                new __await(values[i])
                            ];
                        case 2:
                            ref = _swc_helpers_src_sliced_to_array_mjs__WEBPACK_IMPORTED_MODULE_4__/* ["default"].apply */ .Z.apply(void 0, [
                                _state.sent(),
                                2
                            ]), val = ref[0], done = ref[1], ref;
                            delete values[i];
...
// src/worker.ts
var ProxyToWorker = /*#__PURE__*/ function() {
    "use strict";
    function ProxyToWorker(pathConfig) {
        var nbThread = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, suppressNativeLog = arguments.length > 2 ? arguments[2] : void 0, logger = arguments.length > 3 ? arguments[3] : void 0;
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, ProxyToWorker);
    ...
    (0,_swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(ProxyToWorker, [
        {
            key: "moduleInit",
            value: function moduleInit(ggufFiles) {
                return __async(this, null, function() {
                    var _this, moduleCode, mainModuleCode, runOptions, completeCode, res, nativeFiles, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, id, err;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _this = this;
                                ...
                                moduleCode = this.multiThread ? WLLAMA_MULTI_THREAD_CODE : WLLAMA_SINGLE_THREAD_CODE;
                                mainModuleCode = moduleCode.replace("var Module", "var ___Module");
                                runOptions = {
                                    pathConfig: this.pathConfig,
                                    nbThread: this.nbThread
                                };
                                completeCode = [
                                    "const RUN_OPTIONS = ".concat(JSON.stringify(runOptions), ";"),
                                    "function wModuleInit() { ".concat(mainModuleCode, "; return Module; }"),
                            ...
                            case 2:
                                ...
                                _iterator = ggufFiles[Symbol.iterator]();
                                _state.label = 3;
                            case 3:
                                ...
                                return [
                                    4,
                                    this.fileAlloc(file.name, file.blob.size)
                                ];
                            case 4:
                                id = _state.sent();
                                nativeFiles.push(__spreadValues({
                                    id: id
                                }, file));
                                _state.label = 5;
                            case 5:
                            ...
                            case 9:
                                return [
                                    4,
                                    Promise.all(nativeFiles.map(function(file) {
                                        return _this.fileWrite(file.id, file.blob);
                                    }))
                                ];
                            case 10:
                                _state.sent();
        ...
        {
            key: "wllamaAction",
            value: function wllamaAction(name, body) {
                return __async(this, null, function() {
                    var encodedMsg, result, parsedResult;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                encodedMsg = glueSerialize(body);
                                return [
                                    4,
                                    this.pushTask({
                                        verb: "wllama.action",
                            ...
                            case 1:
                                result = _state.sent();
                                parsedResult = glueDeserialize(result);
                                return [
                                    2,
                                    parsedResult
                                ];
   ...
   */ key: "fileAlloc",
            value: function fileAlloc(fileName, size) {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
   ...
   */ key: "fileWrite",
            value: function fileWrite(fileId, blob) {
                return __async(this, null, function() {
                    var reader, offset, ref, done, value, size;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                            ...
                            case 2:
                                ref = _state.sent(), done = ref.done, value = ref.value;
                                if (done) return [
                                    3,
                                    4
                                ];
   ...
   */ key: "pushTask",
            value: function pushTask(param, buffers) {
                var _this = this;
                return new Promise(function(resolve, reject) {
                ...
                return __async(this, null, function() {
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        ...
                        while(true){
                            ...
                            this.worker.postMessage(task.param, isSafariMobile() ? void 0 : {
   ...
   */ key: "onRecvMsg",
            value: function onRecvMsg(e) {
                if (!e.data) return;
                var _data = e.data, verb = _data.verb, args = _data.args;
                if (verb && verb.startsWith("console.")) {
                    var _logger, _logger1, _logger2, _logger3;
                    if (this.suppressNativeLog) {
                        return;
                    }
                    if (verb.endsWith("debug")) (_logger = this.logger).debug.apply(_logger, (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(args));
                    if (verb.endsWith("log")) (_logger1 = this.logger).log.apply(_logger1, (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(args));
                    if (verb.endsWith("warn")) (_logger2 = this.logger).warn.apply(_logger2, (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(args));
                    if (verb.endsWith("error")) (_logger3 = this.logger).error.apply(_logger3, (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(args));
                    return;
                } else if (verb === "signal.abort") {
                    this.abort(args[0]);
                }
                var _data1 = e.data, callbackId = _data1.callbackId, result = _data1.result, err = _data1.err;
                if (callbackId) {
                    var idx = this.resultQueue.findIndex(function(t) {
                        return t.param.callbackId === callbackId;
                    });
                    if (idx !== -1) {
                        var waitingTask = this.resultQueue.splice(idx, 1)[0];
                        if (err) waitingTask.reject(err);
                        else waitingTask.resolve(result);
                    } else {
                        this.logger.error("Cannot find waiting task with callbackId = ".concat(callbackId));
                    }
                }
            }
        },
        {
            key: "abort",
            value: function abort(text) {
                while(this.resultQueue.length > 0){
                    var waitingTask = this.resultQueue.pop();
                    if (!waitingTask) break;
                    waitingTask.reject(new Error("Received abort signal from llama.cpp; Message: ".concat(text || "(empty)")));
                }
            }
        }
    ]);
...
var CacheManager = /*#__PURE__*/ function() {
    ...
    function CacheManager() {
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, CacheManager);
    }
    (0,_swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(CacheManager, [
        {
            /**
   ...
   */ key: "getNameFromURL",
            value: function getNameFromURL(url) {
                return __async(this, null, function() {
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
   ...
   */ key: "write",
            value: function write(name, stream, metadata) {
                return __async(this, null, function() {
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
        ...
        {
            key: "download",
            value: function download(_0) {
                return __async(this, arguments, function(url) {
                    var options, worker, aborted, mSignal, metadataFileName, filename;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                options = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : {};
                                worker = createWorker(OPFS_UTILS_WORKER_CODE);
                                aborted = false;
                                if (options.signal) {
                                    aborted = options.signal.aborted;
                                    mSignal = options.signal;
                                    mSignal.addEventListener("abort", function() {
                                        aborted = true;
                                        worker.postMessage({
                                            action: "download-abort"
                                        });
                                ...
                                return [
                                    4,
                                    urlToFileName(url, PREFIX_METADATA)
                                ];
                            case 1:
   ...
   */ key: "getMetadata",
            value: function getMetadata(name) {
                return __async(this, null, function() {
                    var stream, cachedSize, meta, e;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    4,
                                    opfsOpen(name, PREFIX_METADATA)
                                ];
                            case 1:
                                stream = _state.sent();
                                return [
                            ...
                            case 2:
                                cachedSize = _state.sent();
                                if (!stream) {
                                    return [
                                        2,
                                        cachedSize > 0 ? // files created by older version of wllama doesn't have metadata, we will try to polyfill it
                                        {
                                            etag: POLYFILL_ETAG,
   ...
   */ key: "list",
            value: function list() {
                return __async(this, null, function() {
                    var cacheDir, result, metadataMap, iter, more, _$temp, error, _value, name, handler, stream, meta, temp, _tmp, iter2, more2, _$temp2, error2, _value1, name1, handler1, _, _tmp1, _tmp2, _tmp3, temp2, _tmp4;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                            ...
                            case 2:
                                ...
                                iter = __forAwait(cacheDir.entries());
                                _state.label = 3;
                            case 3:
                                return [
                                    4,
                            ...
                            case 4:
                                if (!(more = !(_$temp = _state.sent()).done)) return [
                                    3,
                                    8
                                ];
                                _value = (0,_swc_helpers_src_sliced_to_array_mjs__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(_$temp.value, 2), name = _value[0], handler = _value[1];
                                if (!(handler.kind === "file" && name.startsWith(PREFIX_METADATA))) return [
                                    3,
                                    7
                                ];
                                return [
                            ...
                            case 5:
                                stream = _state.sent().stream();
                                return [
                                    4,
                                    new Response(stream).json().catch(function(_) {
                                        return null;
                                    })
                                ];
                            case 6:
                            ...
                            case 15:
                                ...
                                iter2 = __forAwait(cacheDir.entries());
                                _state.label = 16;
                            case 16:
                                return [
                                    4,
                            ...
                            case 17:
                                if (!(more2 = !(_$temp2 = _state.sent()).done)) return [
                                    3,
                                    22
                                ];
                                _value1 = (0,_swc_helpers_src_sliced_to_array_mjs__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(_$temp2.value, 2), name1 = _value1[0], handler1 = _value1[1];
                                if (!(handler1.kind === "file" && !name1.startsWith(PREFIX_METADATA))) return [
                                    3,
                                    21
                                ];
                                _ = result.push;
                                ...
                                return [
                                    4,
                                    handler1.getFile().then(function(f) {
                                        return f.size;
                                    })
                                ];
                            case 18:
                                _tmp1.size = _state.sent();
                                _tmp2 = metadataMap[name1];
                                if (_tmp2) return [
                                    3,
                                    20
                                ];
                            ...
                            case 19:
                                _tmp2 = (_tmp3.// try to polyfill for old versions
                                originalSize = _state.sent().size, _tmp3.originalURL = "", _tmp3.etag = "", _tmp3);
                                _state.label = 20;
                            case 20:
                                _.apply(result, [
                                    (_tmp1.metadata = _tmp2, _tmp1)
                                ]);
                                _state.label = 21;
                            case 21:
                                more2 = false;
                            ...
                            case 24:
                                ...
                                _tmp4 = more2 && (_$temp2 = iter2.return);
                                if (!_tmp4) return [
                                    3,
                                    26
                                ];
   ...
   */ key: "delete",
            value: function _delete(nameOrURL) {
                return __async(this, null, function() {
                    var name2;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    4,
                                    this.getNameFromURL(nameOrURL)
                                ];
                            case 1:
                                name2 = _state.sent();
                                return [
                                    4,
                                    this.deleteMany(function(entry) {
                                        return entry.name === nameOrURL || entry.name === name2;
                                    })
                                ];
                            case 2:
                                _state.sent();
   ...
   */ key: "deleteMany",
            value: function deleteMany(predicate) {
                return __async(this, null, function() {
                    var cacheDir, list, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
   ...
   */ key: "writeMetadata",
            value: function writeMetadata(name, metadata) {
                return __async(this, null, function() {
                    var blob;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    opfsWrite(name, blob.stream(), PREFIX_METADATA)
                                ];
                            case 1:
                                _state.sent();
                                return [
...
function opfsWrite(key, stream) {
    var prefix = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
    return __async(this, null, function() {
        var fileName, writable, reader, ref, done, value, e;
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            switch(_state.label){
                case 0:
                    _state.trys.push([
                    ...
                    return [
                        4,
                        urlToFileName(key, prefix)
                    ];
                case 1:
                    fileName = _state.sent();
                    return [
                        4,
                        opfsWriteViaWorker(fileName)
                    ];
                case 2:
...
function opfsOpen(originalURLOrName) {
    var prefix = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
    return __async(this, null, function() {
        var _this, getFileHandler, handler, fileName;
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            switch(_state.label){
                case 0:
                    _this = this;
                    getFileHandler = function(fname) {
                        return __async(_this, null, function() {
                            var cacheDir, fileHandler, e;
                            return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                                switch(_state.label){
                                    case 0:
                                        _state.trys.push([
                                    ...
                                    case 1:
                                        ...
                                        return [
                                            4,
                                            cacheDir.getFileHandle(fname)
                                        ];
                                    case 2:
                                        fileHandler = _state.sent();
                                        return [
                                            4,
                                            fileHandler.getFile()
                                        ];
                    ...
                    return [
                        4,
                        getFileHandler(originalURLOrName)
                    ];
                case 1:
                    handler = _state.sent();
                    if (handler) {
                    ...
                    return [
                        4,
                        urlToFileName(originalURLOrName, prefix)
                    ];
                case 2:
                    fileName = _state.sent();
                    return [
...
function opfsFileSize(originalURL) {
    var prefix = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
    return __async(this, null, function() {
        var cacheDir, fileName, fileHandler, file, e;
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            switch(_state.label){
                case 0:
                    _state.trys.push([
                ...
                case 1:
                    ...
                    return [
                        4,
                        urlToFileName(originalURL, prefix)
                    ];
                case 2:
                    fileName = _state.sent();
                    return [
...
function opfsWriteViaWorker(fileName) {
    return __async(this, null, function() {
        var _this, worker, pResolve, pReject, workerExec;
        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
            switch(_state.label){
                case 0:
                    _this = this;
                    ...
                    workerExec = function(data) {
                        return new Promise(function(resolve, reject) {
                            pResolve = resolve;
                            pReject = reject;
                            worker.postMessage(data, isSafariMobile() ? void 0 : {
                                transfer: data.value ? [
                                    data.value.buffer
                                ] : []
                            });
...
var ModelValidationStatus = /* @__PURE__ */ function(ModelValidationStatus2) {
...
var Model = /*#__PURE__*/ function() {
    "use strict";
    function Model(modelManager, url, savedFiles) {
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, Model);
     ...
     */ __publicField(this, "files");
        ...
        if (savedFiles) {
            ...
            this.size = sumArr(this.files.map(function(f) {
                return f.metadata.originalSize;
            }));
        } else {
            this.files = [];
            this.size = 0;
    ...
    (0,_swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(Model, [
        {
            /**
   ...
   */ key: "open",
            value: function open() {
                return __async(this, null, function() {
                    var blobs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, blob, err;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                if (this.size === -1) {
                            ...
                            case 2:
                                ...
                                return [
                                    4,
                                    this.modelManager.cacheManager.open(file.name)
                                ];
                            case 3:
                                blob = _state.sent();
                                if (!blob) {
                                    throw new Error("Failed to open file ".concat(file.name, "; Hint: the model may be invalid, please refresh it"));
                                }
                                blobs.push(blob);
                                _state.label = 4;
                            case 4:
   ...
   */ key: "validate",
            value: function validate() {
                var nbShards = ModelManager.parseModelUrl(this.url).length;
                if (this.size === -1) {
   ...
   */ key: "refresh",
            value: function refresh() {
                return __async(this, arguments, function() {
                    var options, _this, _a, urls, works, nParallel, totalSize, loadedSize, worker, promises, i, _, _1, _2;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                _this = this;
                                urls = ModelManager.parseModelUrl(this.url);
                                works = urls.map(function(url, index) {
                                    return {
                                        url: url,
                                        index: index
                                    };
                                ...
                                nParallel = (_a = this.modelManager.params.parallelDownloads) != null ? _a : DEFAULT_PARALLEL_DOWNLOADS;
                                return [
                                    4,
                                    this.getTotalDownloadSize(urls)
                                ];
                            case 1:
                                totalSize = _state.sent();
                                loadedSize = [];
                                worker = function() {
                                    return __async(_this, null, function() {
                                        ...
                                        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                                            switch(_state.label){
                                                        ...
                                                        return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                                                            switch(_state.label){
                                                                case 0:
                                                                    ...
                                                                    return [
                                                                        4,
                                                                        _this.modelManager.cacheManager.download(w.url, __spreadProps(__spreadValues({}, options), {
                                                ...
                                                case 1:
                                                    ...
                                                    return [
                                                        5,
                                                        (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__values)(_loop())
                                                    ];
                                                case 2:
                                                    _ret = _state.sent();
                            ...
                            case 2:
                                _state.sent();
                                _ = this;
                                _2 = (_1 = this).getAllFiles;
                                return [
                                    4,
                                    this.modelManager.cacheManager.list()
                                ];
                            case 3:
                                _.files = _2.apply(_1, [
                                    _state.sent()
                                ]);
                                this.size = this.files.reduce(function(acc, f) {
                                    return acc + f.metadata.originalSize;
                                }, 0);
                                return [
                                    2
                                ];
   ...
   */ key: "remove",
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    4,
                                    this.modelManager.cacheManager.deleteMany(function(f) {
        ...
        {
            key: "getAllFiles",
            value: function getAllFiles(savedFiles) {
                var allUrls = new Set(ModelManager.parseModelUrl(this.url));
                var allFiles = [];
                var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    var _loop = function() {
                        var url = _step.value;
                        var file = savedFiles.find(function(f) {
                            return f.metadata.originalURL === url;
                        });
                        if (!file) {
                            throw new Error("Model file not found: ".concat(url));
                        }
                        allFiles.push(file);
                    };
                    for(var _iterator = allUrls[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true)_loop();
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
                } finally{
                ...
                allFiles.sort(function(a, b) {
                    return a.metadata.originalURL.localeCompare(b.metadata.originalURL);
                });
                return allFiles;
            }
        },
        {
            key: "getTotalDownloadSize",
            value: function getTotalDownloadSize(urls) {
                return __async(this, null, function() {
                    var responses, sizes;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                sizes = responses.map(function(res) {
...
var ModelManager = /*#__PURE__*/ function() {
    "use strict";
    function _ModelManager() {
        var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, _ModelManager);
    ...
    (0,_swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(_ModelManager, [
        {
            /**
   ...
   */ key: "getModels",
            value: function getModels() {
                return __async(this, arguments, function() {
                    var opts, cachedFiles, models, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, shards, isFirstShard;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.cacheManager.list()
                                ];
                            case 1:
                                cachedFiles = _state.sent();
                                models = [];
                                _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                                try {
                                    for(_iterator = cachedFiles[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                                        file = _step.value;
                                        shards = _ModelManager.parseModelUrl(file.metadata.originalURL);
                                        isFirstShard = shards.length === 1 || shards[0] === file.metadata.originalURL;
                                        if (isFirstShard) {
   ...
   */ key: "downloadModel",
            value: function downloadModel(_0) {
                return __async(this, arguments, function(url) {
                    var options, model, validity;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                if (!isValidGgufFile(url)) {
                                    throw new WllamaError("Invalid model URL: ".concat(url, '; URL must ends with ".gguf"'), "download_error");
                                }
                                model = new Model(this, url, void 0);
                                validity = model.validate();
                                if (!(validity !== "valid" /* VALID */ )) return [
                                    3,
                                    2
                                ];
                                return [
   ...
   */ key: "getModelOrDownload",
            value: function getModelOrDownload(_0) {
                return __async(this, arguments, function(url) {
                    var options, _a, models, model;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                            ...
                            case 1:
                                ...
                                if (model) {
                                    (_a = options.progressCallback) == null ? void 0 : _a.call(options, {
                                        loaded: model.size,
                                        total: model.size
                                    });
                                    return [
                                ...
                                return [
                                    2,
                                    this.downloadModel(url, options)
                                ];
                        }
                    });
                });
   ...
   */ function parseModelUrl(modelUrl) {
                ...
                var urlPartsRegex = /-(\d{5})-of-(\d{5})\.gguf(?:\?.*)?$/;
                var queryMatch = modelUrl.match(/\.gguf(\?.*)?$/);
                var queryParams = (_a = queryMatch == null ? void 0 : queryMatch[1]) != null ? _a : "";
                var matches = modelUrl.match(urlPartsRegex);
                if (!matches) {
                    return [
                        modelUrl
                    ];
                }
                var baseURL = modelUrl.replace(urlPartsRegex, "");
                var total = matches[2];
                var paddedShardIds = Array.from({
                    length: Number(total)
                }, function(_, index) {
                    return (index + 1).toString().padStart(5, "0");
                });
                return paddedShardIds.map(function(current) {
                    return "".concat(baseURL, "-").concat(current, "-of-").concat(total, ".gguf").concat(queryParams);
                });
            }
        }
    ]);
...
var WllamaError = /*#__PURE__*/ function(Error1) {
    "use strict";
    (0,_swc_helpers_src_inherits_mjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(WllamaError, Error1);
    var _super = (0,_swc_helpers_src_create_super_mjs__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(WllamaError);
    function WllamaError(message) {
        var type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "unknown_error";
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, WllamaError);
        var _this;
        _this = _super.call(this, message);
        __publicField((0,_swc_helpers_src_assert_this_initialized_mjs__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(_this), "type");
        _this.type = type;
        return _this;
    }
    return WllamaError;
}((0,_swc_helpers_src_wrap_native_super_mjs__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z)(Error));
var WllamaAbortError = /*#__PURE__*/ function(Error1) {
    "use strict";
    (0,_swc_helpers_src_inherits_mjs__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(WllamaAbortError, Error1);
    var _super = (0,_swc_helpers_src_create_super_mjs__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z)(WllamaAbortError);
    function WllamaAbortError() {
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, WllamaAbortError);
        var _this;
        _this = _super.call(this, "Operation aborted");
        __publicField((0,_swc_helpers_src_assert_this_initialized_mjs__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(_this), "name", "AbortError");
        return _this;
    }
    return WllamaAbortError;
}((0,_swc_helpers_src_wrap_native_super_mjs__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z)(Error));
var Wllama = /*#__PURE__*/ function() {
    "use strict";
    function Wllama(pathConfig) {
        var wllamaConfig = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        (0,_swc_helpers_src_class_call_check_mjs__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(this, Wllama);
    ...
    (0,_swc_helpers_src_create_class_mjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(Wllama, [
        {
            key: "logger",
        ...
        {
            key: "checkModelLoaded",
            value: function checkModelLoaded() {
   ...
   */ key: "isTokenEOG",
            value: function isTokenEOG(token) {
   ...
   *
   * @returns -1 if the model is not loaded.
   */ key: "getDecoderStartToken",
            value: function getDecoderStartToken() {
   ...
   */ key: "getModelMetadata",
            value: function getModelMetadata() {
   ...
   *
   * @returns true if multi-thread is used.
   */ key: "isEncoderDecoderArchitecture",
            value: function isEncoderDecoderArchitecture() {
                this.checkModelLoaded();
   ...
   */ key: "mustAddBosToken",
            value: function mustAddBosToken() {
                this.checkModelLoaded();
   ...
   */ key: "mustAddEosToken",
            value: function mustAddEosToken() {
                this.checkModelLoaded();
   ...
   */ key: "getChatTemplate",
            value: function getChatTemplate() {
                var _a;
                this.checkModelLoaded();
   ...
   * @param config
   */ key: "loadModelFromUrl",
            value: function loadModelFromUrl(_0) {
                return __async(this, arguments, function(modelUrl) {
                    var config, _a, url, useCache, model, _tmp, blobs;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                config = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : {};
                                url = isString(modelUrl) ? modelUrl : modelUrl[0];
                                useCache = (_a = config.useCache) != null ? _a : true;
                                if (!useCache) return [
                                    3,
                                    2
                                ];
                                return [
                                    4,
                                    this.modelManager.getModelOrDownload(url, config)
                                ];
                            case 1:
                                _tmp = _state.sent();
                                return [
                            ...
                            case 2:
                                return [
                                    4,
                                    this.modelManager.downloadModel(url, config)
                                ];
                            case 3:
                                _tmp = _state.sent();
                                _state.label = 4;
   ...
   * @param config
   */ key: "loadModelFromHF",
            value: function loadModelFromHF(_0, _1) {
                return __async(this, arguments, function(modelId, filePath) {
                    var config;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.loadModelFromUrl("https://huggingface.co/".concat(modelId, "/resolve/main/").concat(filePath), config)
                                ];
                            case 1:
                                return [
                                    2,
   ...
   */ key: "loadModel",
            value: function loadModel(_0) {
                return __async(this, arguments, function(ggufBlobsOrModel) {
                    var config, _a, _b, blobs, _tmp, supportMultiThread, hasPathMultiThread, hwConccurency, nbThreads, mPathConfig, modelFiles, startResult, loadResult, loadedCtxInfo, i;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                config = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : {};
                                if (!(0,_swc_helpers_src_instanceof_mjs__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(ggufBlobsOrModel, Model)) return [
                                    3,
                                    2
                                ];
                                return [
                                    4,
                                    ggufBlobsOrModel.open()
                                ];
                            case 1:
                                _tmp = _state.sent();
                                return [
                            ...
                            case 2:
                                _tmp = (0,_swc_helpers_src_to_consumable_array_mjs__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(ggufBlobsOrModel);
                                _state.label = 3;
                            case 3:
                                blobs = _tmp;
                                if (blobs.some(function(b) {
                                    return b.size === 0;
                                })) {
                            ...
                            case 4:
                                ...
                                this.proxy = new ProxyToWorker(mPathConfig, this.useMultiThread ? nbThreads : 1, (_b = this.config.suppressNativeLog) != null ? _b : false, this.logger());
                                modelFiles = blobs.map(function(blob, i) {
                                    return {
                                        name: "model-".concat(i, ".gguf"),
                                        blob: blob
                                    };
                                });
                                return [
                                    4,
                                    this.proxy.moduleInit(modelFiles)
                                ];
                            case 5:
                                _state.sent();
                                return [
                                    4,
                                    this.proxy.wllamaStart()
                                ];
                            case 6:
                                startResult = _state.sent();
                                if (!startResult.success) {
                                    throw new WllamaError("Error while calling start function, result = ".concat(startResult));
                                }
                                return [
                                    4,
                                    this.proxy.wllamaAction("load", {
                                        _name: "load_req",
                                        use_mmap: true,
                                        use_mlock: true,
                                        n_gpu_layers: 0,
                                        ...
                                        n_ctx_auto: false,
                                        // not supported for now
                                        model_paths: modelFiles.map(function(f) {
                                            return "models/".concat(f.name);
                                        }),
                            ...
                            case 7:
                                loadResult = _state.sent();
                                loadedCtxInfo = __spreadProps(__spreadValues({}, loadResult), {
                                    metadata: {}
                                });
                                for(i = 0; i < loadResult.metadata_key.length; i++){
        ...
        {
            key: "getLoadedContextInfo",
            value: function getLoadedContextInfo() {
                this.checkModelLoaded();
   ...
   */ key: "createEmbedding",
            value: function createEmbedding(_0) {
                return __async(this, arguments, function(text) {
                    var options, opt, tokens, result;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.samplingInit(this.samplingConfig)
                                ];
                            case 1:
                                _state.sent();
                                return [
        ...
        },
        {
            ...
            value: function createChatCompletion(messages, options) {
                return __async(this, null, function() {
                    var prompt, _tmp;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    4,
                                    this.createCompletionGenerator(prompt, options)
                                ];
                            case 2:
                                _tmp = _state.sent();
                                return [
                            ...
                            case 3:
                                return [
                                    4,
                                    this.createCompletion(prompt, __spreadProps(__spreadValues({}, options), {
                                        stream: false
                                    }))
                                ];
                            case 4:
        ...
        },
        {
            ...
            value: function createCompletion(prompt, options) {
                return __async(this, null, function() {
                    var _tmp;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
   ...
   */ key: "createCompletionImpl",
            value: function createCompletionImpl(prompt, options) {
                return __async(this, null, function() {
                    var _a, _b, _c, _d, stopTokens, tokens, outBuf, abort, abortSignalFn, i, sampled;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                this.checkModelLoaded();
                            ...
                            case 1:
                                _state.sent();
                                stopTokens = new Set((_b = options.stopTokens) != null ? _b : []);
                                return [
                                    4,
                                    this.tokenize(prompt, true)
                                ];
                            case 2:
                                tokens = _state.sent();
                                ...
                                return [
                                    4,
                                    this.computeNonCachedTokens(tokens)
                                ];
                            case 3:
                                tokens = _state.sent();
                                return [
                            ...
                            case 6:
                                return [
                                    4,
                                    this.samplingAccept(tokens)
                                ];
                            case 7:
                                _state.sent();
                                if (!this.isEncoderDecoderArchitecture()) return [
                                    3,
                                    10
                                ];
                                return [
                            ...
                            case 12:
                                ...
                                abort = false;
                                abortSignalFn = function() {
                                    abort = true;
                                };
                                i = 0;
                                _state.label = 13;
                            case 13:
                                if (!(i < ((_c = options.nPredict) != null ? _c : Infinity))) return [
                                    3,
                                    18
                                ];
                                return [
   ...
   */ key: "createCompletionGenerator",
            value: function createCompletionGenerator(prompt, options) {
                var _this = this;
                return new Promise(function(resolve, reject) {
                    var createGenerator = cbToAsyncIter(function(callback) {
                        _this.createCompletionImpl(prompt, __spreadProps(__spreadValues({}, options), {
                            onNewToken: function(token, piece, currentText) {
                                callback({
                                    token: token,
                                    piece: piece,
   ...
   */ key: "samplingInit",
            value: function samplingInit(_0) {
                return __async(this, arguments, function(config) {
                    var pastTokens, _a, logitBias, logitBiasTok, logitBiasVal, result;
                    var _arguments = arguments;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                pastTokens = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : [];
                                this.checkModelLoaded();
                                this.samplingConfig = config;
                                logitBias = (_a = config.logit_bias) != null ? _a : [];
                                logitBiasTok = logitBias.map(function(b) {
                                    return b.token;
                                });
                                logitBiasVal = logitBias.map(function(b) {
                                    return b.bias;
                                });
                                return [
                                    4,
                                    this.proxy.wllamaAction("sampling_init", __spreadProps(__spreadValues({
                                        _name: "sint_req"
                                    }, config), {
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("get_vocab", {
                                        _name: "gvoc_req"
                                    })
                                ];
                            case 1:
   ...
   */ key: "lookupToken",
            value: function lookupToken(piece) {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("lookup_token", {
                                        _name: "lkup_req",
                                        piece: piece
                                    })
                                ];
   ...
   */ key: "tokenize",
            value: function tokenize(text) {
                var special = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("tokenize", {
                                        _name: "tokn_req",
                                        text: text,
                                        special: !!special
                                    })
        ...
        },
        {
            ...
            value: function detokenize(tokens) {
                var returnString = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("detokenize", {
                                        _name: "dtkn_req",
                                        tokens: tokens
                                    })
                                ];
                            case 1:
                                ...
                                return [
                                    2,
                                    returnString ? bufToText(result.buffer) : result.buffer
                                ];
                        }
                    });
                });
   ...
   */ key: "decode",
            value: function decode(tokens, options) {
                return __async(this, null, function() {
                    var _a, batches, result, i, isNotLast;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                this.checkModelLoaded();
                                ...
                                batches = this.breakTokensIntoBatches(tokens, this.loadedContextInfo.n_batch);
                                i = 0;
                                _state.label = 1;
                            case 1:
                                ...
                                isNotLast = batches.length > 1 && i < batches.length - 1;
                                return [
                                    4,
                                    this.proxy.wllamaAction("decode", {
                                        _name: "deco_req",
                                        tokens: batches[i],
   ...
   * @returns n_past (number of tokens so far in the sequence)
   */ key: "encode",
            value: function encode(tokens, options) {
                return __async(this, null, function() {
                    var _a, batches, result, i;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                this.checkModelLoaded();
                            ...
                            case 1:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("encode", {
                                        _name: "enco_req",
                                        tokens: batches[i]
                                    })
                                ];
        ...
        {
            key: "breakTokensIntoBatches",
            value: function breakTokensIntoBatches(tokens, maxBatchSize) {
                var batches = [];
                for(var i = 0; i < tokens.length; i += maxBatchSize){
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("sampling_sample", {
                                        _name: "ssam_req"
                                    })
                                ];
                            case 1:
   ...
   * @param tokens
   */ key: "samplingAccept",
            value: function samplingAccept(tokens) {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("sampling_accept", {
                                        _name: "sacc_req",
                                        tokens: tokens
                                    })
                                ];
   ...
   */ key: "getLogits",
            value: function getLogits() {
                var topK = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 40;
                return __async(this, null, function() {
                    var result, logits, i;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("get_logits", {
                                        _name: "glog_req",
                                        top_k: topK
                                    })
                                ];
   ...
   */ key: "embeddings",
            value: function embeddings(tokens) {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
   ...
   * @param nDiscard
   */ key: "kvRemove",
            value: function kvRemove(nKeep, nDiscard) {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("kv_remove", {
                                        _name: "kvcr_req",
                                        n_keep: nKeep,
                                        n_discard: nDiscard
                                    })
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("kv_clear", {
                                        _name: "kvcc_req"
                                    })
                                ];
                            case 1:
   ...
   */ key: "formatChat",
            value: function formatChat(messages, addAssistant, template) {
                return __async(this, null, function() {
                    var roles, contents, result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                this.checkModelLoaded();
                                roles = messages.map(function(m) {
                                    return m.role;
                                });
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("chat_format", {
                                        _name: "cfmt_req",
                                        roles: roles,
                                        contents: contents,
                                        tmpl: template,
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("set_options", __spreadValues({
                                        _name: "opti_req"
                                    }, opt))
                                ];
                            case 1:
                    ...
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    4,
                                    (_a = this.proxy) == null ? void 0 : _a.wllamaExit()
                                ];
                            case 1:
                                _state.sent();
                                this.proxy = null;
   ...
   */ key: "_testBenchmark",
            value: function _testBenchmark(type, nSamples) {
                return __async(this, null, function() {
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("test_benchmark", {
                                        _name: "tben_req",
                                        type: type,
                                        n_samples: nSamples
                                    })
   ...
   */ key: "_testPerplexity",
            value: function _testPerplexity(tokens) {
                return __async(this, null, function() {
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("test_perplexity", {
                                        _name: "tper_req",
                                        tokens: tokens
                                    })
                                ];
        ...
        },
        {
            ///// Prompt cache utils /////
            key: "getCachedTokens",
            value: function getCachedTokens() {
                return __async(this, null, function() {
                    var result;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.proxy.wllamaAction("current_status", {
                                        _name: "stat_req"
                                    })
                                ];
                            case 1:
   ...
   */ key: "computeNonCachedTokens",
            value: function computeNonCachedTokens(seq) {
                return __async(this, null, function() {
                    var cachedTokens, nKeep, e;
                    return (0,_swc_helpers_src_ts_generator_mjs__WEBPACK_IMPORTED_MODULE_2__.__generator)(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                            ...
                            case 1:
                                ...
                                this.logger().debug("Cache nKeep=".concat(nKeep));
                                _state.label = 2;
                            case 2:
                                _state.trys.push([
                                    2,
                                ...
                                return [
                                    4,
                                    this.kvRemove(nKeep, -1)
                                ];
                            case 3:
                                _state.sent();
                                return [
                                    2,
                                    seq.slice(nKeep, seq.length)
                                ];
                            case 4:
                                e = _state.sent();
